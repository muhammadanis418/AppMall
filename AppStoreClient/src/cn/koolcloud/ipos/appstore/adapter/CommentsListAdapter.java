...
public class CommentsListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.userHeaderImageView = (ImageView) convertView.findViewById(R.id.user_header);	
			holder.ratingBar = (RatingBar) convertView.findViewById(R.id.soft_detail_comment_item_rating);							
			holder.userNickNameTextView = (TextView) convertView.findViewById(R.id.soft_detail_comment_item_nickname);
			holder.commentDateTextView = (TextView) convertView.findViewById(R.id.soft_detail_comment_item_date);
			holder.commentTextView = (TextView) convertView.findViewById(R.id.soft_detail_comment_item_text);
