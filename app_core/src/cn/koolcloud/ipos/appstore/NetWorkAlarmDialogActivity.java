...
public class NetWorkAlarmDialogActivity extends BaseActivity implements View.OnClickListener {
	...
	private void initViews() {
		...
		titleTextView.setText(Utils.getResourceString(getApplicationContext(),
				R.string.dialog_network_alarm_title));
		...
		if (!isNetAvailable) {
			strBuffer.append(Utils.getResourceString(getApplicationContext(),
					R.string.dialog_network_not_available));
		}
