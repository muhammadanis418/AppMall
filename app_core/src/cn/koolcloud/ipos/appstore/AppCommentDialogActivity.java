...
public class AppCommentDialogActivity extends BaseActivity implements View.OnClickListener {
	...
	private void commitComment(String comment, int rating) {
		ApiService.commitComment(application, MySPEdit.getTerminalID(application), 
	...
	private CallBack commitCommentCallBack = new CallBack() {
		...
		public void onSuccess(JSONObject jsonObj) {
			try {
				String retCode = "";
				MyLog.d("-------commit Comment=" + jsonObj.toString());
