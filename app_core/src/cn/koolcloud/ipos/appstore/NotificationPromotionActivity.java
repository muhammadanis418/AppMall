...
public class NotificationPromotionActivity extends BaseActivity {
	...
	private void initViews() {
		initActionBar();
		subCategoryGridView = (GridView) findViewById(R.id.subCategoryGridView);
	}
	...
	private void initViewStatus() {
		if (null != dataJson) {
			...
			subCategoryGridView.setAdapter(mAdapter);
