...
//        HttpURLConnection connection = null;
        ...
        try {
        	...
        	String terminalId = MySPEdit.getTerminalID(mContext);
            ...
            try {
                ...
                if (response != null) {
    				...
    				if (statusCode == 200 || statusCode == 206) {
    	                ...
    	                MyLog.d("sub thread get block size:" + response.getEntity().getContentLength());
    					...
    					MyLog.d("==redirect download url==" + urlStr);
    					...
    					if (newResponse != null) {
    						...
    						if (statusCode == 200 || statusCode ==206) {
    	    	                ...
    	    	                MyLog.d("sub thread get block size:" + newResponse.getEntity().getContentLength());
    	    	                byte[] buffer = new byte[bufferSize];
    	    	                int length = -1;
